...
#-----------------------------------------------------------------------
# $Id: Dir.pm,v 2.9 2007/03/16 22:19:49 vadim Exp $
#-----------------------------------------------------------------------
...
use             KA::Tie::Dir::System;   # Subroutines for system files

#-----------------------------------------------------------------------

$VERSION        = sprintf("%d.%d", q$Revision: 2.9 $ =~ /(\d+)\.(\d+)/);
@ISA            = qw(KA::Tie::Dir::System Tie::Hash Exporter);
...
#-----------------------------------------------------------------------
# $Log: Dir.pm,v $
# Revision 2.9  2007/03/16 22:19:49  vadim
# ActiveState/Windows & Debian testing.
#
#-----------------------------------------------------------------------
1;
